...
object WaypointMarker {
  fun render(event: RenderWorldLastEvent) {
    ...
    val posX: Double = player.prevPosX + (player.posX - player.prevPosX) * partialTicks
    val posY: Double = player.prevPosY + (player.posY - player.prevPosY) * partialTicks
    val posZ: Double = player.prevPosZ + (player.posZ - player.prevPosZ) * partialTicks
