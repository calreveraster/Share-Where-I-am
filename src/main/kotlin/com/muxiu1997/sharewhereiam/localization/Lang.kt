...
object Lang {
  ...
  @Localization(prefix = PREFIX_CHAT, en = "SAVE") lateinit var SHARE_WAYPOINT_SAVE: LocalizedString
  ...
  @Localization(prefix = PREFIX_CHAT, en = "EDIT") lateinit var SHARE_WAYPOINT_EDIT: LocalizedString
  ...
  @Localization(
      prefix = PREFIX_CHAT,
      en =
          "This is a VisualProspecting Waypoint, you still need to add the Waypoint to the VP in the way that the VP allows")
  ...
  @Localization(prefix = PREFIX_KEYBINDING, en = "Share Where I am")
