...
class MessageMarkWaypoint : IMessage {
  ...
  companion object {
    object Handler :
        IMessageHandler<MessageMarkWaypoint, IMessage?>, IClientSideHandler, IServerSideHandler {
      ...
      private fun handleClientSideMessage(message: MessageMarkWaypoint) {
        WaypointManager.addTransientBeacon(
            message.playerName, Waypoint.fromString(message.waypointJson))
      }
